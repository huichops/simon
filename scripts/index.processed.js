...
/***/ function(module, exports, __webpack_require__) {
	...
	var YELLOW = _constants2.default.YELLOW,
	    BLUE = _constants2.default.BLUE,
	    RED = _constants2.default.RED,
	    GREEN = _constants2.default.GREEN;
	var START = _constants2.default.START,
	    ADDING = _constants2.default.ADDING,
	    LOST = _constants2.default.LOST,
	    PLAYING = _constants2.default.PLAYING;

	var colors = [RED, BLUE, YELLOW, GREEN];

	var Game = function () {
	  function Game(uiHandler) {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function addNew() {
	      if (this.gameState != ADDING) throw new Error('Invalid game action for state ' + this.gameState);
	    ...
	    value: function start() {
	      if (this.gameState != START) throw new Error('Invalid game action for state ' + this.gameState);
	      this.sequence.push(this.getRandomColor());
	      this.sequence.push(this.getRandomColor());
	      this.sequence.push(this.getRandomColor());
	      this.uiHandler.lightSequence(this.sequence, this.startTurn);
	...
	var UIHandler = function () {
	  ...
	  _createClass(UIHandler, [{
	    key: 'lightSequence',
	    value: function lightSequence(sequence, cb) {
	      var _this = this;

	      sequence.reduce(function (p, s) {
	        return p.then(function () {
	          return new Promise(function (resolve) {
	            setTimeout(function () {
	              resolve(_this.turn(s));
	            }, 500);
	          });
	        }).then(function () {
	          return new Promise(function (resolve) {
